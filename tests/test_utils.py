...
def test_get_data(test_url):
    ...
    assert get_data("https://net.url.com")[0] is None
    assert get_data("https://github.com/Miklefil")[0] is None
    assert get_data("https://githuoib.com/Miklefilaaaaa")[0] is None
